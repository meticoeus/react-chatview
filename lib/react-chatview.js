...
var ChatView = function (_Component) {
  ...
  function ChatView(props) {
    ...
    _this.setScrollable = _this.setScrollable.bind(_this);
    _this.setSmoothScrollingWrapper = _this.setSmoothScrollingWrapper.bind(_this);
    return _this;
  }
  ...
  _createClass(ChatView, [{
    ...
    key: 'getIsInfiniteLoading',
    value: function getIsInfiniteLoading() {
      return this.props.usePropLoading ? this.props.isInfiniteLoading : this.state.isInfiniteLoading;
    }
  }, {
    key: 'setScrollable',
    value: function setScrollable(e) {
      this.scrollable = e;
    }
  }, {
    key: 'setSmoothScrollingWrapper',
    value: function setSmoothScrollingWrapper(e) {
    ...
    value: function render() {
      ...
      if (this.props.useSmoothScrollingWrapper) {
        return _react2.default.createElement(
          'div',
          { className: this.props.className, ref: this.setScrollable,
            style: this.props.scrollableStyle
          },
          _react2.default.createElement(
            'div',
            { ref: this.setSmoothScrollingWrapper },
...
ChatView.propTypes = {
  ...
  usePropLoading: _propTypes2.default.bool,
  isInfiniteLoading: _propTypes2.default.bool,
  loadingSpinnerDelegate: _propTypes2.default.element,
  useSmoothScrollingWrapper: _propTypes2.default.bool,
